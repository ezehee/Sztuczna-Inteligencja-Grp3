...
# Zadanie 3
df = pd.read_csv("_info-data-discrete.txt", sep=" ", header=None)
df1 = pd.read_csv("australian.txt", sep=" ", header=None)
df2 = pd.read_csv("australian.txt", sep=" ", header=None)
...
# Wczytanie plików
df1 = pd.read_csv("australian-type.txt", sep=" ", header=None)
df2 = pd.read_csv("australian.txt", sep=" ", header=None)
...
df_d = pd.read_csv("australian.txt", sep=" ", header=None)
print(df_d.nunique())

# Zadanie 3e
print("\nZadanie 3e ------------------------------------------------------------\n")

df_e = pd.read_csv("australian.txt", sep=" ", header=None)
...
df_f = pd.read_csv("australian.txt", sep=" ", header=None)
...
df_a = pd.read_csv("australian.txt", sep=" ", header=None)
...
df_b = pd.read_csv("australian.txt", sep=" ", header=None)
